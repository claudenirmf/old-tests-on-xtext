...
public class OntoLLib {
  public final static String UFO_A_LIB = "br/ufes/inf/nemo/ontol/libraries/ufo_a.ontol";
  
  public final static String DATATYPES_LIB_NAME = "ontol.datatypes";
  
  public final static String UFO_A_LIB_NAME = "ontol.ufo.a";
  
  public final static String DATATYPES_STRING = (OntoLLib.DATATYPES_LIB_NAME + ".String");
  
  public final static String DATATYPES_INTEGER = (OntoLLib.DATATYPES_LIB_NAME + ".Integer");
  ...
  public final static String UFO_A_SORTAL_ENDURANT = (OntoLLib.UFO_A_LIB_NAME + ".SortalEndurant");
  
  public final static String UFO_A_NONSORTAL_ENDURANT = (OntoLLib.UFO_A_LIB_NAME + ".NonSortalEndurant");
  
  public final static String UFO_A_RIGID_ENDURANT = (OntoLLib.UFO_A_LIB_NAME + ".RigidEndurant");
  
  public final static String UFO_A_SEMIRIGID_ENDURANT = (OntoLLib.UFO_A_LIB_NAME + ".SemiRigidEndurant");
  
  public final static String UFO_A_ANTIRIGID_ENDURANT = (OntoLLib.UFO_A_LIB_NAME + ".AntiRigidEndurant");
